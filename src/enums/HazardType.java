...
public enum HazardType {
   ...
   *
   * <p>- If hit by a penguin: The penguin is stunned (skips next turn). - Can slide and fall off
   * the grid. - Stops if it hits a SeaLion (transmitting movement).
   */
  LIGHT_ICE_BLOCK("LB"),
   ...
   *
   * <p>- Acts as a wall. - Penalty: The colliding penguin loses their lightest food item.
   */
  HEAVY_ICE_BLOCK("HB"),
   ...
   *
   * <p>- If hit: The penguin bounces back in the opposite direction. - The Sea Lion starts sliding
   * in the penguin's original direction.
   */
  SEA_LION("SL"),
   ...
   *
   * <p>- Penguins falling in are removed from the game (food is still counted). - Sliding objects
   * (LB, SL) falling in will "Plug" the hole, making it safe.
   */
  HOLE_IN_ICE("HI");
